...
// Jede Sektion traegt oben `py-16` (64px) Innenabstand, bevor ihr
// Kopf beginnt. Ohne Korrektur bleibt zwischen Nav (48px) und dem
// sichtbaren Abschnittskopf eine grosse leere Luecke. -16 zieht den
// Sprung so weit hoch, dass der Kopf direkt unter der Nav sitzt.
